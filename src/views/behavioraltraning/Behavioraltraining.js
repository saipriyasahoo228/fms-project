...
function createData(id,slno,behavioraltraining,date,trainername,refrno) {
  return { id,slno,behavioraltraining,date,trainername,refrno };
}
...
export default function Behavioraltraining() {
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.behavioraltraining}</TableCell>
