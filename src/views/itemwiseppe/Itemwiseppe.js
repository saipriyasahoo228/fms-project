...
function createData(id, empcode, empname, helmet, shoe, glove) {
  return { id, empcode, empname, helmet, shoe, glove};
}
...
const headCells = [
  ...
  { id: 'glove', numeric: true, disablePadding: false, label: 'Gloves' },
];
